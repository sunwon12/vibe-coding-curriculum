...
type: 개발
tags: ["바이브코딩", "레퍼런스", "비개발자", "암묵지", "진단", "그림설명", "자동화"]
created: 2026-08-17
updated: 2026-09-18
...
`⭐ 쉬움 · 🕐 필요할 때 찾아보기` · 💡 암묵지는 [[AI02-AI가-모르는-암묵지-주입하기]], 컨텍스트는 [[AI03-주입할-것과-읽힐-때-설계하기]], 도구 실습은 [[AI04-AI에게-도구로-손발-달아주기]]
...
> 방법은 → [[AI01-지식베이스-깔고-AI와-연결하기]] · [[AI02-AI가-모르는-암묵지-주입하기]]
...
| 대화를 기억하기 | 매 턴 다시 읽는 구조 | **파일로 남긴다** → [[AI03-주입할-것과-읽힐-때-설계하기]] |
...
> 자세히는 → [[AI04-AI에게-도구로-손발-달아주기]] · [[제품03-안전하게-지키기-보안-체크리스트]]
...
- **멋있어 보여서 MCP를 잔뜩 설치.** 도구가 읽어온 것도 **컨텍스트를 먹어요.** 필요한 것만.
  (왜 그런지 → [[AI03-주입할-것과-읽힐-때-설계하기]])
- **처음부터 쓰기·삭제 권한을 줌.** **읽기 전용부터.** 신뢰가 쌓인 뒤에 늘리세요.
- **설치 후 앱을 안 껐다 켬.** MCP가 안 붙는 이유의 90%예요. **완전 종료 → 재실행.**

## 관련

자동화 후보 찾기 → [[AI00-내-일에서-자동화-후보-찾기]] · 컨텍스트 관리 → [[AI03-주입할-것과-읽힐-때-설계하기]] ·
도구 설치 실습 → [[AI04-AI에게-도구로-손발-달아주기]] ·
암묵지 꺼내기 → [[AI02-AI가-모르는-암묵지-주입하기]] ·
막힐 때 → [[자주-막히는것-FAQ]] · 모르는 단어 → [[용어집-비개발자용]]

> 🖼️ 이 문서의 그림은 mermaid예요. 깃허브 웹·Orca 등 Mermaid를 지원하는 미리보기에서 **그림으로 보여요.**
